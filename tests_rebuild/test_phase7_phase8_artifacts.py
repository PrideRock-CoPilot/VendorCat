...
def test_databricks_smoke_workflow_exists_and_is_strict() -> None:
    workflow_path = Path(".github/workflows/rebuild-databricks-smoke.yml")
...
def test_cutover_scripts_and_docs_exist() -> None:
    required_paths = [
        Path("scripts/rebuild/cutover_preflight.ps1"),
        Path("scripts/rebuild/cutover_execute.ps1"),
        Path("scripts/rebuild/cutover_smoke.ps1"),
        Path("scripts/rebuild/rollback_prepare.ps1"),
