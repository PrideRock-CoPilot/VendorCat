...
CREATE INDEX IF NOT EXISTS idx_vendor_primary_business_unit_id ON vendor(primary_business_unit_id);
...
CREATE INDEX IF NOT EXISTS idx_offering_primary_business_unit_id ON offering(primary_business_unit_id);
CREATE INDEX IF NOT EXISTS idx_project_primary_business_unit_id ON project(primary_business_unit_id);
CREATE INDEX IF NOT EXISTS idx_contract_vendor_status ON contract(vendor_id, contract_status);
CREATE INDEX IF NOT EXISTS idx_contract_offering_status ON contract(offering_id, contract_status);
CREATE INDEX IF NOT EXISTS idx_contract_event_contract_ts ON contract_event(contract_id, event_ts);
CREATE INDEX IF NOT EXISTS idx_vendor_demo_vendor_date ON vendor_demo(vendor_id, demo_date);
CREATE INDEX IF NOT EXISTS idx_vendor_demo_offering_date ON vendor_demo(offering_id, demo_date);
CREATE INDEX IF NOT EXISTS idx_vendor_demo_score_demo ON vendor_demo_score(demo_id);
CREATE INDEX IF NOT EXISTS idx_vendor_demo_note_demo ON vendor_demo_note(demo_id, created_at);

CREATE INDEX IF NOT EXISTS idx_vendor_business_unit_assignment_vendor ON vendor_business_unit_assignment(vendor_id, active_flag);
CREATE INDEX IF NOT EXISTS idx_vendor_business_unit_assignment_bu ON vendor_business_unit_assignment(business_unit_id, active_flag);
CREATE INDEX IF NOT EXISTS idx_offering_business_unit_assignment_offering ON offering_business_unit_assignment(offering_id, active_flag);
CREATE INDEX IF NOT EXISTS idx_offering_business_unit_assignment_bu ON offering_business_unit_assignment(business_unit_id, active_flag);
...
CREATE INDEX IF NOT EXISTS idx_custom_attribute_definition_scope_key ON custom_attribute_definition(scope, attribute_key, is_active);
CREATE INDEX IF NOT EXISTS idx_custom_attribute_value_scope_entity ON custom_attribute_value(scope, entity_id, definition_id);
...
CREATE INDEX IF NOT EXISTS idx_app_import_lookup_candidate_job_status ON app_import_lookup_candidate(import_job_id, status, lookup_type);
CREATE INDEX IF NOT EXISTS idx_core_vendor_offering_business_unit ON core_vendor_offering(business_unit, lifecycle_state);
