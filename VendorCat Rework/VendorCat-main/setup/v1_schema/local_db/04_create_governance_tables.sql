...
CREATE TABLE IF NOT EXISTS custom_attribute_definition (
    ...
    updated_by TEXT,
    UNIQUE (scope, attribute_key)
);

CREATE TABLE IF NOT EXISTS custom_attribute_value (
    attribute_value_id TEXT PRIMARY KEY,
    scope TEXT NOT NULL,
    entity_id TEXT NOT NULL,
    ...
    updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_by TEXT,
    FOREIGN KEY (definition_id) REFERENCES custom_attribute_definition(definition_id),
    UNIQUE (scope, entity_id, definition_id)
);
