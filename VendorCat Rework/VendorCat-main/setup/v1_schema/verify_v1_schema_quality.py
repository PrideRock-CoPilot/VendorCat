...
REQUIRED_TABLES = {
    ...
    "app_import_stage_vendor",
    "app_import_stage_vendor_contact",
    "app_import_stage_vendor_owner",
    "app_import_stage_offering",
    "app_import_stage_offering_owner",
    "app_import_stage_offering_contact",
    "app_import_stage_contract",
    "app_import_stage_project",
...
REQUIRED_FOREIGN_KEYS: dict[str, set[str]] = {
    ...
    "offering": {"vendor", "lkp_lifecycle_state", "lkp_business_unit", "lkp_service_type"},
    "contract": {"vendor", "offering"},
    "contract_event": {"contract"},
    "vendor_demo": {"vendor", "offering"},
    "vendor_demo_score": {"vendor_demo"},
    "vendor_demo_note": {"vendor_demo"},
    "project": {"lkp_lifecycle_state", "lkp_business_unit"},
    "vendor_identifier": {"vendor"},
    "vendor_business_unit_assignment": {"vendor", "lkp_business_unit"},
    "offering_business_unit_assignment": {"offering", "lkp_business_unit"},
    ...
    "custom_attribute_value": {"custom_attribute_definition"},
    ...
    "app_import_stage_row": {"app_import_job"},
    "app_import_stage_vendor": {"app_import_job"},
    "app_import_stage_vendor_contact": {"app_import_job"},
    "app_import_stage_vendor_owner": {"app_import_job"},
    "app_import_stage_offering": {"app_import_job"},
    "app_import_stage_offering_owner": {"app_import_job"},
    "app_import_stage_offering_contact": {"app_import_job"},
    "app_import_stage_contract": {"app_import_job"},
    "app_import_stage_project": {"app_import_job"},
    "app_import_stage_vendor_identifier": {"app_import_job"},
    "app_import_review_area_state": {"app_import_job"},
    "app_import_mapping_profile_request": {"app_import_job"},
    "app_import_lookup_candidate": {"app_import_job"},
...
REQUIRED_UNIQUE_GROUPS: dict[str, set[tuple[str, ...]]] = {
    ...
    "vendor_business_unit_assignment": {("vendor_id", "business_unit_id", "active_flag")},
    "offering_business_unit_assignment": {("offering_id", "business_unit_id", "active_flag")},
    "vendor_merge_member": {("merge_id", "vendor_id")},
    "custom_attribute_definition": {("scope", "attribute_key")},
    "custom_attribute_value": {("scope", "entity_id", "definition_id")},
    ...
    "app_import_stage_row": {("import_job_id", "row_index")},
    "app_import_lookup_candidate": {("import_job_id", "lookup_type", "option_code")},
