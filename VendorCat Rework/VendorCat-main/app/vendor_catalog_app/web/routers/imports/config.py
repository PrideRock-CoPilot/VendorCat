...
IMPORT_STAGING_AREAS: dict[str, dict[str, Any]] = {
    "vendor": {
        ...
        "fields": (
            ...
            ("compliance_category", "Vendor - Compliance Category"),
            ("gl_category", "Vendor - GL Category"),
            ("delegated_vendor_flag", "Vendor - Delegated Flag"),
            ("health_care_vendor_flag", "Vendor - Health Care Flag"),
            ("notes", "Vendor - Notes"),
        ),
    },
    "vendor_identifier": {
        "label": "Vendor Identifier",
        "stage_table": "app_import_stage_vendor_identifier",
        "fields": (
            ("vendor_id", "Vendor Identifier - Vendor ID"),
            ("identifier_type", "Vendor Identifier - Type"),
            ("identifier_value", "Vendor Identifier - Value"),
            ("is_primary", "Vendor Identifier - Primary"),
            ("country_code", "Vendor Identifier - Country"),
        ),
    },
    "vendor_contact": {
    ...
    "offering": {
        ...
        "fields": (
            ...
            ("business_unit", "Offering - Business Unit"),
...
IMPORT_LAYOUT_FIELD_TARGET_KEYS: dict[str, dict[str, str]] = {
    ...
    "offerings": {
        ...
        "business_unit": "offering.business_unit",
        ...
        "sample_rows": [
            {
                ...
                "business_unit": "internal_platform",
                "service_type": "saas",
                "lifecycle_state": "draft",
