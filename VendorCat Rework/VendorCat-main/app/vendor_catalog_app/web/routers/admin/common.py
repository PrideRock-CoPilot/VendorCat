...
ADMIN_SECTION_IMPORT_MAPPINGS = "import-mappings"
...
LOOKUP_TYPE_LABELS = {
    ...
    LOOKUP_TYPE_OFFERING_BUSINESS_UNIT: "Offering Business Units",
    LOOKUP_TYPE_OFFERING_SERVICE_TYPE: "Offering Service Types",
    LOOKUP_TYPE_OWNER_ORGANIZATION: "Owner Organizations",
    LOOKUP_TYPE_VENDOR_CATEGORY: "Vendor Categories",
    LOOKUP_TYPE_COMPLIANCE_CATEGORY: "Compliance Categories",
    LOOKUP_TYPE_GL_CATEGORY: "GL Categories",
    LOOKUP_TYPE_RISK_TIER: "Risk Tiers",
    LOOKUP_TYPE_LIFECYCLE_STATE: "Lifecycle States",
...
def _admin_redirect_url(
    *,
    ...
    if section == ADMIN_SECTION_IMPORT_MAPPINGS:
        return f"/admin/{ADMIN_SECTION_IMPORT_MAPPINGS}"
