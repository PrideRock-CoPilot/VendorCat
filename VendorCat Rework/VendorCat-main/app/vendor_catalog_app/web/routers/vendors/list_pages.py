...
async def vendor_new_submit(request: Request):
    ...
    if legacy_owner_org_id and not form_values["owner_org_choice"]:
    ...
    if form_values["owner_org_choice"] == "__new__":
        field_errors["owner_org_choice"] = "Select a managed Business Unit."
    elif not owner_org_id:
        field_errors["owner_org_choice"] = "Business Unit is required."
