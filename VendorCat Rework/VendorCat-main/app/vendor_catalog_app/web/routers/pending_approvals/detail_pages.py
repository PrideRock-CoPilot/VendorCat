...
def workflow_detail(request: Request, change_request_id: str, return_to: str = "/workflows"):
    ...
    row["_business_unit_values"] = _payload_business_unit_values(payload, {})
    row["_business_unit_display"] = (
        ", ".join(row["_business_unit_values"]) if row["_business_unit_values"] else "-"
    )
