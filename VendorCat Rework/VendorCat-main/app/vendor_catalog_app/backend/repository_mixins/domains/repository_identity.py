...
class RepositoryIdentityMixin:
    def ensure_runtime_tables(self) -> None:
        ...
        try:
            ...
            missing_or_blocked.append(f"{self._report_table('core_vendor_offering')}.business_unit")
            missing_or_blocked.append(f"{self._report_table('core_vendor_offering')}.service_type")
        try:
            self._probe_file(
